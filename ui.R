...
dashboardPage(
    skin = "green",
    dashboardHeader(title = "Swiftkey"),
    dashboardSidebar(id="",
                     sidebarMenu(
    ...
    dashboardBody(
        tabItems(
            ...
            tabItem(
                ...
                fluidRow(
                    box(width=12,
                        h4("This application serves as the final product for a Data Science project as part of the challenge involved figuring out how to work with a new type of data to develop a working prediction algorithm and ultimately a useful data product.", 
                           tags$br(), tags$br(), 
